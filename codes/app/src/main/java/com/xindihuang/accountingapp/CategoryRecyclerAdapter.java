...
public class CategoryRecyclerAdapter extends RecyclerView.Adapter<CategoryViewHolder> {
    ...
    private LinkedList<CategoryResBean> cellList = GlobalUtil.getInstance().costRes;  //cost should be default

    public String getSelected() {
        return selected;
    }

    private String selected="";    //store which category is selected
    ...
    public CategoryRecyclerAdapter(Context context){
        ...
        selected = cellList.get(0).title;      //the first one is selected by default
    }
