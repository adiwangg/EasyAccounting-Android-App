...
public class GlobalUtil {
    ...
    private static int[] earnIconRes = {
            ...
            R.drawable.icon_stock_white,
            R.drawable.icon_poker_white,
            R.drawable.icon_gamble_white};
    ...
    private static int[] earnIconResBlack = {
            ...
            R.drawable.icon_stock_black,
            R.drawable.icon_gamble_black};

    private static String[] earnTitle = {"General", "Reimburse", "Salary","RedPocket","Part-time", "Bonus","Investment","Stock",
            "Gamble"};
